...
// Keeps a table of all players, the key is the socket id
var players = {}; 
// Keeps track of all the bullets to update them on the server 
var bullet_array = []; 
...
function ServerGameLoop(){
  for(var i=0;i<bullet_array.length;i++){
    ...
    if(bullet.x < -10 || bullet.x > 1200 || bullet.y < -10 || bullet.y > 1000){
